  ...
  var initHome = () => {
    ...
    const showSecondSlideOnHover = () => {
      layoutItemEl.forEach((el) => {
        ...
        } else if (window.detectMobile() || window.mobileAndTabletCheck() || matchTablet() || matchLandscapeTablet() || matchBigMobile() || matchMediumMobile() || matchSmallMobile()) {
          addClass();
        } else {
          addClass();
        }
